...
const Footer = () => {
  return (
    <footer className="footer items-center py-4 bg-secondary text-primary-content/80 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.2)]">
      <div className="flex flex-col md:flex-row justify-between items-center container mx-auto px-3 xl:px-[72px]">
